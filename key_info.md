...
## macOS
<b> To install R and RStudio </b>
 - Download R from [here](https://cran.r-project.org/bin/macosx/sonoma-arm64/base/R-4.6.0-arm64.pkg).
    - <b>Note that for older Macs without the M1/M2 chip </b>, you must select the appropriate Intel download from [here](https://cran.r-project.org/bin/macosx/big-sur-x86_64/base/R-4.6.0-x86_64.pkg). 
